...
- Multipart upload from browser to Worker API, then into Ramdisk backend (`mem-server`)
- Encrypted blob storage in volatile memory (Ramdisk)
...
4. (Optional) Create R2 bucket if you want to run `STORAGE_BACKEND=r2` later:
